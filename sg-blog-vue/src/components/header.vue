...
<div class="">
                       ...
                       <el-menu-item index="/Friendslink">
						...
						<div class="userInfo">
							<div style="position: relative;">
							  <span class="iconfont" style="font-size: 27px;color: red; position: absolute; top: 50%; z-index: 10;transform: translateY(-50%); right: 10px;">&#xe667;</span>
							  <el-input class="pcsearchbox" v-model="input" placeholder="请输入内容"></el-input>
							</div>
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/zlkbackground.jpg)'}">
		<div class="scene">
			<div><span id="luke"></span></div>
		</div>
		<!-- <div class="h-information">
                    <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:'static/img/CID1375430_20230828190058.gif'" alt="">
			<!-- <h2 class="h-description">

                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"以自由之姿，创不世之度"}}
                </h2> -->
		</div> -->
	</div>
</div>
...
export default {
	data() { //选项 / 数据
		return {
			...
			// path:'',//当前打开页面的路径
			input: '', //input输入内容
			headBg: 'url(static/img/zlkbackground.jpg)', //头部背景图
			headTou: '', //头像
			projectList: '' //项目列表
		}
	},
